...
void app_main(void)
{
	...
	GB_initButtons(); // VMTO: Inicializa los botones y sus recursos
    ...
    //VMTO: Inicializa el driver del I2C y del ds1621
    // Utilizaci�n de los pines GPIO_NUM_12--> SDA GPIO_NUM_13--> SCL
    ret = i2c_master_init(I2C_NUM_0, GPIO_NUM_12, GPIO_NUM_13, GPIO_PULLUP_ENABLE, false);
    ESP_ERROR_CHECK(ret);
